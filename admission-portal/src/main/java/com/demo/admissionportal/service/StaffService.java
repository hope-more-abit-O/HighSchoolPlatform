...
public interface StaffService {
    ...
    ResponseData<Page<StaffResponseDTO>> findAll(String username, String firstName, String lastName, String email, String phone, Pageable pageable);
    ...
    ResponseData<?> activateStaffById(int id);
}
