...
public interface StaffService {
    ...
    ResponseData<Page<StaffResponseDTO>> findAll(String username, String firstName, String middleName, String lastName, String email, String phone, String status, Pageable pageable);
