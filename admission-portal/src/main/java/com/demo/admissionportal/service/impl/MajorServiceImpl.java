...
public class MajorServiceImpl {
    ...
    public List<Major> findByIds(List<Integer> ids) throws ResourceNotFoundException{
    ...
    public Major save(Major major) throws StoreDataFailedException {
        try {
    ...
    public List<Major> save(List<Major> majors) throws StoreDataFailedException {
        try {
    ...
    public void checkForExistingMajorNamesAndCodes(List<CreateMajorDTO> createMajorDTOs) throws DataExistedException {
    ...
    public List<Major> createAndSaveMajors(List<CreateMajorDTO> majorDTOs, Integer createById) throws StoreDataFailedException {
    ...
    public List<Major> checkAndInsert(List<CreateMajorDTO> majors) throws DataExistedException, StoreDataFailedException {
    ...
    public List<Major> insertNewMajorsAndGetExistedMajors(List<CreateMajorDTO> createMajorDTOs, List<Integer> majorIds) throws StoreDataFailedException {
