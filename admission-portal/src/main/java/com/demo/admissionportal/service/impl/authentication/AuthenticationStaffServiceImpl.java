...
public class AuthenticationStaffServiceImpl implements AuthenticationStaffService {
    ...
    public ResponseData<LoginResponseDTO> login(LoginRequestDTO request) {
        try {
            ...
            revokeAllStudentTokens(staff);
            saveStudentToken(staff, jwtToken, refreshToken);
    ...
    private void revokeAllStudentTokens(Staff staff) {
    ...
    private void saveStudentToken(Staff staff, String jwtToken, String refreshToken) {
