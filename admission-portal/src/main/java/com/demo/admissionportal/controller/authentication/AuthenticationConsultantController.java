...
/**
 * The type Authentication consultant controller.
 */
@RestController
@RequestMapping("/api/v1/auth/consultant")
@RequiredArgsConstructor
public class AuthenticationConsultantController {
    private final AuthenticationConsultantService authenticationConsultantService;
    ...
    public ResponseEntity<ResponseData<LoginResponseDTO>> login(@RequestBody @Valid LoginRequestDTO request) {
        ...
        ResponseData<LoginResponseDTO> loginAccount = authenticationConsultantService.login(request);
