...
/**
 * The type Authentication university controller.
 */
@RestController
@RequestMapping("/api/v1/auth/university")
@RequiredArgsConstructor
public class AuthenticationUniversityController {
    private final AuthenticationUniversityService authenticationUniversityService;
    ...
    public ResponseEntity<ResponseData<LoginResponseDTO>> login(@RequestBody @Valid LoginRequestDTO request) {
        ...
        ResponseData<LoginResponseDTO> loginAccount = authenticationUniversityService.login(request);
