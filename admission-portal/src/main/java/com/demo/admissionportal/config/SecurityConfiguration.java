        ...
        http
                ...
                .authorizeHttpRequests(
                        req -> req
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/v1/admission/compare").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/university-training-program/major/{major-id}").permitAll()
