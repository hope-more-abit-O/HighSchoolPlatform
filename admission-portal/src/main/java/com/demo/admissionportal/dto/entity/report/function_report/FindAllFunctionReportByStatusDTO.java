...
@NoArgsConstructor
@AllArgsConstructor
public class FindAllFunctionReportByStatusDTO {
    ...
    public FindAllFunctionReportByStatusDTO(Integer reportId, ReportStatus status, Date createTime, ReportType reportType, Integer createById, String ticketId) {
