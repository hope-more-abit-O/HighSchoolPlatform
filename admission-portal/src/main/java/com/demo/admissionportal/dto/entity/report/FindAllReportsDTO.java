...
@AllArgsConstructor
@NoArgsConstructor
public class FindAllReportsDTO {
    ...
    public FindAllReportsDTO(Integer reportId, String ticketId, Integer createById, Date createTime, ReportStatus status, ReportType reportType) {
